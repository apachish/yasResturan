$('#collapseMap').on('shown.bs.collapse', function(e) {
    ...
    var map = L.map('map', {
        center: [35.778094, 51.376193],
        minZoom: 2,
        zoom: 13
    });

    L.tileLayer( 'https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
     attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">map</a> &copy; <a href="https://www.mapbox.com/about/maps/">Mapbox</a>',
     tileSize: 512,
     maxZoom: 18,
     zoomOffset: -1,
     id: 'mapbox/streets-v11', 
     accessToken: 'pk.eyJ1IjoiY2hhdmVhbWluIiwiYSI6ImNsM21oZ2d6cTA0cmozZGxuY3NpenR1MWYifQ.cDfXqDYt7lYeFjSEUNjJvA',// Your Mapbox Access Token
     subdomains: ['a','b','c']
    }).addTo( map );
    ...
    for (var i = 0; i < markers.length; ++i) {
        var popup =
            ...
            '<form action="http://maps.google.com/maps" method="get" target="_blank"><input name="saddr" value="' + markers[i].get_directions_start_address + '" type="hidden"><input type="hidden" name="daddr" value="' + markers[i].location_latitude + ',' + markers[i].location_longitude + '"><button type="submit" value="Get directions" class="btn_infobox_get_directions">آدرس</button></form>' +
