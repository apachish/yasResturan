<main>
    <!-- START SLIDER -->
    <div dir="ltr" id="rev_slider_45_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="website-intro"
         data-source="gallery" style="background:#000000;padding:0px;">
        <div id="rev_slider_45_1" class="rev_slider fullscreenbanner tiny_bullet_slider" style="display:none;"
             data-version="5.4.8">
            <ul>
                <li data-index="rs-67" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                    ...
                    <!-- main image -->
                    <img src="{{asset("/asset/revolution-slider/assets/images/slide_10.jpg")}}" alt="" data-bgposition="center center"
                    ...
                    <div class="tp-caption tp-resizeme" id="slide-67-layer-2"
                         ...
                         data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                         style="z-index: 19; white-space: nowrap; font-size: 90px; line-height: 90px; font-weight: 600; color: #ffffff; font-family: 'iranyekan', tahoma;">
                        بهترین غذاها را<br />میل کنید</div>
                    <div class="tp-caption tp-resizeme" id="slide-67-layer-3"
                        ...
                        تجربه حضور در یک رستوران بی نظیر</div>
                ...
                <li data-index="rs-66" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                    ...
                    data-param8="" data-param9="" data-param10="" data-description=""
                    data-slicey_shadow="0px 0px 0px 0px transparent">
                    <img src="{{asset("/asset/revolution-slider/assets/images/slide_11.jpg")}}" alt="" data-bgposition="center center"
                         data-kenburns="on" data-duration="5000" data-ease="Power2.easeInOut" data-scalestart="100"
                         data-scaleend="150" data-rotatestart="0" data-rotateend="0" data-blurstart="20"
                         data-blurend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg"
                         data-no-retina>
                    ...
                    <div class="tp-caption   tp-resizeme" id="slide-66-layer-3"
                         ...
                         data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                         style="z-index: 20; min-width: 480px; max-width: 480px; white-space: normal; font-size: 25px; line-height: 35px; font-weight: 400; color: #ffffff; font-family: 'iranyekan', tahoma;">
                        خوب پسندان، یاس را می پسندند</div>
                    <div class="tp-caption tp-resizeme btn_1"
                         data-actions='[{"event":"click","action":"scrollbelow","offset":"-49px","delay":"","speed":"300","ease":"Linear.easeNone"}]'
                ...
                <li data-index="rs-68" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                    ...
                    data-param8="" data-param9="" data-param10="" data-description=""
                    data-slicey_shadow="0px 0px 0px 0px transparent">
                    <img src="{{asset("/asset/revolution-slider/assets/images/slide_14.jpg")}}" alt="" data-bgposition="center center"
                         data-kenburns="on" data-duration="5000" data-ease="Power2.easeInOut" data-scalestart="100"
                         data-scaleend="150" data-rotatestart="0" data-rotateend="0" data-blurstart="20"
                         data-blurend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg"
                         data-no-retina>
                    ...
                    <div class="tp-caption tp-resizeme" id="slide-68-layer-3"
                         ...
                         data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                         style="z-index: 20; min-width: 480px; max-width: 480px; white-space: normal; font-size: 25px; line-height: 35px; font-weight: 400; color: #ffffff; font-family: 'iranyekan', tahoma;">
                        خیابان ولیعصر، روبروی درب اصلی پارک ملت</div>
                    <div class="tp-caption tp-resizeme btn_1"
                         data-actions='[{"event":"click","action":"scrollbelow","offset":"-49px","delay":"","speed":"300","ease":"Linear.easeNone"}]'
                         id="slide-68-layer-7" data-x="['center','center','center','center']"
                         data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']"
                         data-voffset="['200','200','160','120']" data-width="250" data-height="none"
                         data-whitespace="nowrap" data-type="button" data-actions='' data-responsive_offset="on"
                         data-frames='[{"delay":1000,"speed":2000,"frame":"0","from":"sX:0.9;sY:0.9;opacity:0;fb:20px;","to":"o:1;fb:0;","ease":"Power3.easeInOut"},{"delay":"wait","speed":500,"frame":"999","to":"sX:0.9;sY:0.9;opacity:0;fb:20px;","ease":"Power3.easeInOut"},{"frame":"hover","speed":"0","ease":"Linear.easeNone","to":"o:1;rX:0;rY:0;rZ:0;z:0;fb:0;","style":"c:rgba(255,255,255,1);bs:solid;bw:0 0 0 0;"}]'
    ...
    <div class="container margin_60">
        <div class="main_title center">
            <span><em></em></span>
            <h2>غذاهای محبوب</h2>
            <p>لذت غذاهای جذاب در رستوان یاس</p>
        </div>
        <!-- /main_title -->
        ...
        <div class="owl-carousel owl-theme categories_carousel">
            <div class="item_version_2">
                <a href="grid-listing-filterscol.html">
                    <figure>
                        <img src="{{asset("/asset/img/home_cat_pizza.jpg")}}" alt=""
            ...
            <div class="item_version_2">
                <a href="grid-listing-filterscol.html">
                    <figure>
                        <img src="{{asset("/asset/img/home_cat_sushi.jpg")}}" alt=""
                             class="owl-lazy" width="350" height="450">
                        <div class="info">
                            <h3>ژاپنی</h3>
                        </div>
            ...
            <div class="item_version_2">
                <a href="grid-listing-filterscol.html">
                    <figure>
                        <img src="{{asset("/asset/img/home_cat_hamburgher.jpg")}}" alt=""
                             class="owl-lazy" width="350" height="450">
                        <div class="info">
                            <h3>برگر</h3>
                        </div>
            ...
            <div class="item_version_2">
                <a href="grid-listing-filterscol.html">
                    <figure>
                        <img src="{{asset("/asset/img/home_cat_vegetarian.jpg")}}" alt=""
                             class="owl-lazy" width="350" height="450">
                        <div class="info">
                            <h3>گیاهی</h3>
                        </div>
            ...
            <div class="item_version_2">
                <a href="grid-listing-filterscol.html">
                    <figure>
                        <img src="{{asset("/asset/img/home_cat_mexican.jpg")}}" alt=""
                             class="owl-lazy" width="350" height="450">
                        <div class="info">
                            <h3>مکزیکی</h3>
                        </div>
