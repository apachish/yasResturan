        ...
        <div id="rev_slider_45_1" class="rev_slider fullscreenbanner tiny_bullet_slider" style="display:none;"
            ...
            <ul>
                ...
                <li data-index="rs-{{$slide->id}}" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                    ...
                    <!-- main image -->
                    <img src="{{asset("/images/slides/".$slide->image)}}" alt="" data-bgposition="center center"
    ...
    <div class="container margin_60">
        ...
        <div class="owl-carousel owl-theme categories_carousel">
            ...
            <div class="item_version_2">
                <a href="{{route("food-menu")}}">
                    <figure>
                        <img src="{{asset("/images/popular_foods/".$popular_food->image)}}" alt=""
                             class="owl-lazy" width="350" height="450">
                        <div class="info">
                            <h3>{{$popular_food->title}}</h3>
                        </div>
                    </figure>
                </a>
            </div>
